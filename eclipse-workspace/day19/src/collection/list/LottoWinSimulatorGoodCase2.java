...
public class LottoWinSimulatorGoodCase2 {
	...
	// 1~45 사이의 난수를 하나 뽑는 용도로 메서드를 작성합니다.
	 ...
	 public Integer getPowerNumber() {
		...
		// return rn.nextInt(1, 27);
		return new Random().nextInt(1, 27); // 익명개체 활용 
	 }
	 ...
	 public void tryWinLoop(List<Integer> winNumbers, List<Integer>getNumbers, Integer winNumber, Integer getNumber) {
		 while(!(winNumbers.equals(getNumbers) && winNumber.equals(getNumber))) {
