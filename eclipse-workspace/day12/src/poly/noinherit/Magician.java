...
public class Magician {
	...
	// 생성자를 입력해주세요. 
	// id만 입력받고 hp = 20, atk = 3, def = 1로 고정됩니다.
	...
	public void showStatus() {
		...
		System.out.println("공경력 : " + this.atk);
	...
	public void huntRabbit(Rabbit rabbit) {
		if (rabbit.getHp() <= 0) {
			System.out.println("죽어있는 토끼입니다.");
			return; // 이미 죽은 토끼는 아래 로직을 실행할 필요 없
		}
		//1. 내가 공격한 rabbit의 체력 -3
	...
	// Pig, Ghost 생성
	// Warrior 클래스에 huntPig, huntGhost를 정의하세요.
	// Magician 을 유저클래스로 정희해주세요. Warrior처럼 동작합니다. 
